...
$MIX2MONO_exe_link = "https://github.com/ymich9963/mix2mono/releases/latest/download/mix2mono.exe"
...
New-Item -Path $MIX2MONO_install_path -ItemType Directory | Out-Null # make new dir and suppress output
